...
function Home({ setPublicPage }) {
  ...
  const features = [
    {
      ...
      desc: "AI-powered models identify at-risk customers before they leave, giving your team time to act.",
    },
    {
      icon: "👥",
      title: "Customer Segmentation",
      desc: "Automatically segment your base by tenure, contract type, demographics, and behavior.",
    },
    {
      icon: "📈",
      title: "Revenue Analytics",
      desc: "Track MRR, churn rates, and lifetime value across all customer cohorts in real time.",
    },
    {
      icon: "🔔",
      title: "Smart Alerts",
      desc: "Get notified instantly when key metrics shift so nothing slips through the cracks.",
    },
    {
      icon: "📋",
      title: "Sales Reports",
      desc: "Beautiful, exportable reports your stakeholders will actually want to read.",
    },
    {
      icon: "🛡️",
      title: "Secure & Reliable",
      desc: "Enterprise-grade security with Firebase Authentication and real-time data sync.",
    },
  ];
  ...
  const stats = [
    ...
    { value: "AI Agent", label: "No need to Query" },
      ...
      <section className="home-hero">
        ...
        <div className="home-hero__content">
          ...
          <p className="home-hero__subtitle">
            RetainSpot gives your team real-time insights into customer
            behavior, churn risk, and revenue health — all in one beautiful
            dashboard.
          </p>
          ...
          <div className="home-hero__trust">
            <span>
              <i>Access granted within 24hrs</i>
            </span>
            <span>
              <i>Setup in 5 minutes</i>
            </span>
            <span>
              <i>Full dashboard access</i>
            </span>
          </div>
        </div>
        ...
        <div className="home-features__inner">
          <div className="home-section-header">
            ...
            <p className="home-section-sub">
              One platform. Full visibility. Zero guesswork.
            </p>
          </div>
        ...
        <div className="home-request__inner">
          <div className="home-request__left">
            ...
            <p className="home-request__sub">
              RetainSpot is invite-only. Send us your email and tell us a bit
              about how you'd use it — we'll set up your account and reach out
              within 24 hours.
            </p>
            <div className="home-request__steps">
              ...
              <div className="home-request__step">
                ...
                <span>
                  We create your account and email you the credentials
                </span>
              </div>
              <div className="home-request__step">
          ...
          <div className="home-request__right">
            {submitted ? (
              <div className="home-request__success">
                ...
                <p>
                  We’ll review your request and reply to you within 24 hours.
                </p>
                <button
                  className="home-btn home-btn--primary"
                  onClick={() => {
                    setSubmitted(false);
                    setFormData({ company: "", email: "", usage: "" });
                  }}
                >
                  Submit Another
                </button>
              ...
              <form className="home-request__form" onSubmit={handleSubmit}>
                ...
                <p className="home-request__note">
                  ...
                  <span onClick={() => setPublicPage("Login")}>
                    Log in here
                  </span>
                </p>
              </form>
