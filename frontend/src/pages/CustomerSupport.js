...
function CustomerSupport({ setPublicPage }) {
  ...
  const faqs = [
    {
      q: "How do I get started with RetainSpot?",
      a: "Simply sign up for a free account, connect your customer data source (CSV upload supported), and your dashboard will populate automatically within minutes.",
    },
    {
      q: "What data does RetainSpot use for churn prediction?",
      a: "RetainSpot analyses customer tenure, contract type, payment method, service usage patterns, demographic data, and engagement history to build accurate churn risk scores.",
    },
    {
      q: "Can I export reports?",
      a: "Yes! All reports, charts, and customer lists can be exported as CSV or PDF. Head to the Sales Report section and click the Export button.",
    },
    {
      q: "How is my data protected?",
      a: "We use Firebase Authentication with enterprise-grade encryption. Your data is stored securely and never shared with third parties.",
    },
    {
      q: "Can I add team members to my account?",
      a: "Yes. Admin accounts can invite team members from the Settings page. Each member gets their own login with role-based access.",
    },
    {
      q: "What is the difference between Active and Churned customers?",
      a: "Active customers are those still subscribed or using your service. Churned customers have cancelled — these are the ones RetainSpot helps you win back.",
    },
  ];
  ...
  const categories = [
    ...
    },
    {
      ...
      desc: "Understanding metrics, charts, and exports.",
    },
    {
      icon: "👥",
      title: "Customer Data",
      desc: "Importing, filtering, and managing customers.",
    },
    {
      icon: "🔒",
      title: "Account & Security",
      desc: "Password, 2FA, billing, and permissions.",
    },
    {
      icon: "🔗",
      title: "Integrations",
      desc: "Connecting third-party tools and APIs.",
    },
    {
      icon: "🐛",
      title: "Bug Reports",
      ...
      <section className="cs-hero">
        ...
        <div className="cs-hero__content">
          ...
          <p className="cs-hero__sub">
            Browse our FAQ, explore help topics, or send us a message.
          </p>
        </div>
      </section>
      ...
      <section className="cs-main">
        <div className="cs-inner">
          <div className="cs-tabs">
            <button
              className={`cs-tab ${activeTab === "faq" ? "cs-tab--active" : ""}`}
              onClick={() => setActiveTab("faq")}
            >
              📋 Frequently Asked Questions
            </button>
            <button
              className={`cs-tab ${activeTab === "contact" ? "cs-tab--active" : ""}`}
          ...
          {activeTab === "faq" && (
            <div className="cs-faq">
              {faqs.map((faq, i) => (
                <div
                  key={i}
                  className={`cs-faq__item ${openFaq === i ? "cs-faq__item--open" : ""}`}
                >
                  <button
                  ...
                  >
                    <span>{faq.q}</span>
                    <span className="cs-faq__chevron">
                      {openFaq === i ? "▲" : "▼"}
                    </span>
                  </button>
                  {openFaq === i && (
                    <div className="cs-faq__answer">{faq.a}</div>
                  )}
                </div>
              ))}
            </div>
              ...
              {submitted ? (
                ...
                <div className="cs-contact__layout">
                  <div className="cs-contact__info">
                    ...
                    <p className="cs-contact__info-sub">
                      We usually respond within 24 hours on business days.
                    </p>
                    <div className="cs-contact__channels">
                      <div className="cs-contact__channel">
                        <span>📧</span>
                        <div>
                          <strong>Email</strong>
                          <span>ahsancalgary@gmail.com</span>
                        </div>
                      </div>
                      <div className="cs-contact__channel">
                        <span>💬</span>
      ...
      <footer className="cs-footer">
        <div className="cs-footer__inner">
          <div className="cs-footer__logo">
            ...
            <span style={{ fontSize: "20px" }}>RetainSpot</span>
          </div>
          ...
          <p className="cs-footer__copy">
            © 2026 RetainSpot. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
